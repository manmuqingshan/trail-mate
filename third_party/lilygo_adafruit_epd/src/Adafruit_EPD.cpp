...
void Adafruit_EPD::end(void)
{
    ...
    // LILYGO's T-Echo Lite demo used a BusIO revision with
    // Adafruit_SPIDevice::end(). Newer PlatformIO BusIO releases removed that
    // API, and the display pins have already been released above.
}
