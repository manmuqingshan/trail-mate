...
| use-case:survey-radio-spectrum | [探测协议空口参数并确认可用性](use-case-diagrams/survey-radio-spectrum.md) | [HTML](use-case-diagrams/survey-radio-spectrum.html) | 2 | Trail Mate / 通信、媒体与投递 | confirmed | high | source-audit | 2026-08-10 |
