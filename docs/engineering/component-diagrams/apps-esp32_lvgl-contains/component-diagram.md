...
- This Component Diagram focuses on the contains function, showing the file in which it is located, the module it belongs to, and signs of reuse and external collaboration.
...
- Description: apps/esp32_lvgl is the package/module boundary to which the function node: contains belongs, used to determine whether the component is a local implementation detail or a cross-module collaboration point.
...
- Relationship meaning: apps/esp32_lvgl -> Function node: contains indicates that the component is hosted by this technical boundary; its role must be explained by entry, call, export, test or configuration evidence, not just by directory location.
...
- Business correlation: If the function node: contains is called by the business Use Case, then apps/esp32_lvgl is a candidate technology landing point for this business capability.
...
- Problem:
 - The current warehouse evidence has not yet been proven. Function node: contains belongs to the stable responsibility of apps/esp32_lvgl and is temporarily treated as a candidate for ownership.
-Drill down: [Module boundary: apps/esp32_lvgl](../../package-diagrams/apps-esp32_lvgl/package-diagram.md) - Return to the package-level boundary of apps/esp32_lvgl and confirm whether the function node: contains belongs to the stable responsibility of this module.

### apps/esp32_lvgl/tests/esp32_lvgl_sd_coredump_contract_smoke.cpp

- Element type: file
- Description: apps/esp32_lvgl/tests/esp32_lvgl_sd_coredump_contract_smoke.cpp is the evidence file of the current component, indicating that the technical responsibilities of function node: contains can be traced back to the specific code location.
...
-Drill down: [Dynamic collaboration: tick calls log_loop_interval](../../sequence-diagrams/tick-calls-log_loop_interval/sequence-diagram.md) - Open this sequence to confirm that the function node: contains in tick -> log_loop_interval Role in it: Is it initiating collaboration, receiving calls, doing orchestration, or only exposing dependent capabilities.
-Drill down: [Dynamic collaboration: add_status_line calls add_label](../../sequence-diagrams/add_status_line-calls-add_label/sequence-diagram.md) - Open this sequence to confirm that the function node: contains in add_status_line -> add_label Role in it: Is it initiating collaboration, receiving calls, doing orchestration, or only exposing dependent capabilities.
-Drill down: [Dynamic collaboration: add_u32_line calls add_label](../../sequence-diagrams/add_u32_line-calls-add_label/sequence-diagram.md) - Open this sequence to confirm that the function node: contains in add_u32_line -> add_label Role in it: Is it initiating collaboration, receiving calls, doing orchestration, or only exposing dependent capabilities.
-Drill down: [Dynamic collaboration: add_hex_line calls add_status_line](../../sequence-diagrams/add_hex_line-calls-add_status_line/sequence-diagram.md) - Open this sequence to confirm that the function node: contains in add_hex_line -> add_status_line Role in it: Is it initiating collaboration, receiving calls, doing orchestration, or only exposing dependent capabilities.
...
- Change impact: Modification of function node: contains may affect the entry logic, calling relationship and business/engineering documents that reference it in apps/esp32_lvgl/tests/esp32_lvgl_sd_coredump_contract_smoke.cpp.
- Confidence: high
- Evidence:
  - apps/esp32_lvgl/tests/esp32_lvgl_sd_coredump_contract_smoke.cpp
 - Component type: function
...
- [Dynamic collaboration: tick calls log_loop_interval](../../sequence-diagrams/tick-calls-log_loop_interval/sequence-diagram.md) - Open this sequence to confirm the role of function node: contains in tick -> log_loop_interval: whether it is initiating collaboration, receiving calls, doing orchestration, or only exposing dependent capabilities.
- [Dynamic collaboration: add_status_line calls add_label](../../sequence-diagrams/add_status_line-calls-add_label/sequence-diagram.md) - Open this sequence to confirm the role of function node: contains in add_status_line -> add_label: whether it is initiating collaboration, receiving calls, doing orchestration, or only exposing dependent capabilities.
- [Dynamic collaboration: add_u32_line calls add_label](../../sequence-diagrams/add_u32_line-calls-add_label/sequence-diagram.md) - Open this sequence to confirm that the function node: contains in add_u32_line -> add_label Role in it: Is it initiating collaboration, receiving calls, doing orchestration, or only exposing dependent capabilities.
- [Dynamic collaboration: add_hex_line calls add_status_line](../../sequence-diagrams/add_hex_line-calls-add_status_line/sequence-diagram.md) - Open this sequence to confirm that the function node: contains in add_hex_line -> add_status_line Role in it: Is it initiating collaboration, receiving calls, doing orchestration, or only exposing dependent capabilities.
