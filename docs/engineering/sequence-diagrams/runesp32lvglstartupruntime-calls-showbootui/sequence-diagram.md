...
- This Sequence Diagram focuses on the technical collaboration fragment of runEsp32LvglStartupRuntime calling showBootUi.
...
- Description: runEsp32LvglStartupRuntime is the source participant of the current Sequence Diagram, used to interpret runEsp32LvglStartupRuntime calls in apps/esp32_lvgl/src/esp32_lvgl_startup_runtime.cpp showBootUi in apps/esp32_lvgl/src/esp32_lvgl_startup_runtime.cpp.
...
- Relationship meaning: runEsp32LvglStartupRuntime -> showBootUi indicates the dependency direction of the current fragment; if the relationship is only import, it can only indicate static dependencies and cannot directly prove the runtime order.
...
- Element type: component
- Description: showBootUi is the target participant of the current Sequence Diagram, used to interpret runEsp32LvglStartupRuntime calls in apps/esp32_lvgl/src/esp32_lvgl_startup_runtime.cpp in apps/esp32_lvgl/src/esp32_lvgl_startup_runtime.cpp showBootUi.
...
- Relationship meaning: runEsp32LvglStartupRuntime -> showBootUi indicates that the target capability is dependent on the current fragment; it is necessary to combine the call evidence to confirm whether it is a runtime call, a type reference or a static import.
...
- Generated from local repository evidence Dynamic collaboration: runEsp32LvglStartupRuntime calls showBootUi.
