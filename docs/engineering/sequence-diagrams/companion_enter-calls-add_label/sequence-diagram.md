# Dynamic collaboration: companion_enter calls add_label
...
- This Sequence Diagram focuses on the technical collaboration fragment where companion_enter calls add_label.
...
- Element type: component
 - Description: companion_enter is the source actor for the current Sequence Diagram, used to interpret companion_enter calls in apps/esp32_lvgl/src/esp32_lvgl_idf_app_registry.cpp for add_label in apps/esp32_lvgl/src/esp32_lvgl_idf_app_registry.cpp.
...
- Relationship meaning: companion_enter -> add_label indicates the dependency direction of the current fragment; if the relationship is only import, it can only indicate static dependencies and cannot directly prove the runtime order.
...
- Element type: component
 - Explanation: add_label is the target actor of the current Sequence Diagram and is used to interpret companion_enter calls in apps/esp32_lvgl/src/esp32_lvgl_idf_app_registry.cpp.
...
- Relationship meaning: companion_enter -> add_label indicates that the target capability is dependent on the current fragment; it needs to be combined with the call evidence to confirm whether it is a runtime call, a type reference or a static import.
...
- Generate from local repository evidence Dynamic collaboration: companion_enter calls add_label.
