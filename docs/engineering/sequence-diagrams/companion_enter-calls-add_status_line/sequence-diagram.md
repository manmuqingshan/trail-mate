# Dynamic collaboration: companion_enter calls add_status_line
...
- This Sequence Diagram focuses on the technical collaboration fragment where companion_enter calls add_status_line.
...
- Element type: component
 - Description: companion_enter is the source actor for the current Sequence Diagram used to interpret companion_enter in apps/esp32_lvgl/src/esp32_lvgl_idf_app_registry.cpp calls add_status_line in apps/esp32_lvgl/src/esp32_lvgl_idf_app_registry.cpp.
...
- Relationship meaning: companion_enter -> add_status_line indicates the dependency direction of the current fragment; if the relationship is only import, it can only indicate static dependency and cannot directly prove the runtime order.
...
- Element type: component
- Description: add_status_line is the target participant of the current Sequence Diagram, used to interpret companion_enter calls in apps/esp32_lvgl/src/esp32_lvgl_idf_app_registry.cpp add_status_line.
...
- Relationship meaning: companion_enter -> add_status_line indicates that the target capability is dependent on the current fragment; it is necessary to combine the call evidence to confirm whether it is a runtime call, a type reference or a static import.
...
- Generate from local repository evidence Dynamic collaboration: companion_enter calls add_status_line.
