# Dynamic collaboration: setBootLog calls lockUi
...
setBootLog in apps/esp32_lvgl/src/esp32_lvgl_startup_runtime.cpp calls lockUi in apps/esp32_lvgl/src/esp32_lvgl_startup_runtime.cpp.

## How to read the picture

- This Sequence Diagram focuses on the technical collaboration fragment of setBootLog calling lockUi.
...
- Description: setBootLog is the source participant of the current Sequence Diagram and is used to interpret setBootLog calls lockUi in apps/esp32_lvgl/src/esp32_lvgl_startup_runtime.cpp.
...
- Relationship meaning: setBootLog -> lockUi indicates the dependency direction of the current fragment; if the relationship is only import, it can only indicate static dependency and cannot directly prove the runtime order.
...
- Element type: component
 - Description: lockUi is the target actor of the current Sequence Diagram, used to interpret setBootLog calls in apps/esp32_lvgl/src/esp32_lvgl_startup_runtime.cpp.
...
- Relationship meaning: setBootLog -> lockUi indicates that the target capability is dependent on the current fragment; it is necessary to combine the call evidence to confirm whether it is a runtime call, a type reference or a static import.
...
- Generate dynamic collaboration from local warehouse evidence: setBootLog calls lockUi.
