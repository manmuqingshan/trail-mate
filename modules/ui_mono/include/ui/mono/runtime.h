...
struct HostCallbacks
{
    ...
    const char* (*status_led_color_label_fn)(uint8_t color_index) = nullptr;
    bool (*keyboard_light_enabled_fn)() = nullptr;
                ...
                public chat::ChatService::IncomingDataObserver
{
  ...
  private:
    ...
    void adjustComposeT9PinyinCandidate(int delta);
    ...
    bool commitPhysicalComposeToText(bool prefer_candidate);
    void rebuildComposeCandidates();
    bool hasPhysicalChinesePreedit() const;
    void clearComposeT9State();
    bool selectComposeT9PinyinCandidate();
    ...
    static constexpr size_t kComposeT9DigitsMax = 16;
    static constexpr size_t kComposeT9PinyinWidth = 16;
    char compose_t9_digits_[kComposeT9DigitsMax] = {};
    size_t compose_t9_digit_len_ = 0;
    char compose_t9_pinyin_candidates_[kComposeCandidateMax][kComposeT9PinyinWidth] = {};
    size_t compose_t9_pinyin_candidate_count_ = 0;
    size_t compose_t9_pinyin_candidate_index_ = 0;
    char compose_t9_selected_pinyin_[kComposeT9PinyinWidth] = {};
    ...
    uint32_t last_screensaver_render_ms_ = 0;
