...
bool RuntimeMeshStatusSource::buildMeshStatusSnapshot(
    ui::mesh::MeshStatusSnapshot& out) const
{
    ...
    out.known_nodes = has_team
                          ? static_cast<uint32_t>(team_snapshot.members.size())
                          : 0U;
...
{
    static RuntimeMeshStatusSource source;
    return source;
}
