...
constexpr ExtraKey kExtraKeys[] = {
    ...
    {"settings", "wifi_password_0", "wifi_pass_0", ValueType::String},
    {"settings", "wifi_ssid_1", "wifi_ssid_1", ValueType::String},
    {"settings", "wifi_password_1", "wifi_pass_1", ValueType::String},
    {"settings", "wifi_ssid_2", "wifi_ssid_2", ValueType::String},
    {"settings", "wifi_password_2", "wifi_pass_2", ValueType::String},
    {"settings", "wifi_ssid_3", "wifi_ssid_3", ValueType::String},
    {"settings", "wifi_password_3", "wifi_pass_3", ValueType::String},
    {"settings", "wifi_ssid_4", "wifi_ssid_4", ValueType::String},
    {"settings", "wifi_password_4", "wifi_pass_4", ValueType::String},
    {"settings", "wifi_ssid_5", "wifi_ssid_5", ValueType::String},
    {"settings", "wifi_password_5", "wifi_pass_5", ValueType::String},
    {"settings", "wifi_ssid_6", "wifi_ssid_6", ValueType::String},
    {"settings", "wifi_password_6", "wifi_pass_6", ValueType::String},
    {"settings", "wifi_ssid_7", "wifi_ssid_7", ValueType::String},
    {"settings", "wifi_password_7", "wifi_pass_7", ValueType::String},
    {"settings", "wifi_ssid_8", "wifi_ssid_8", ValueType::String},
    {"settings", "wifi_password_8", "wifi_pass_8", ValueType::String},
    {"settings", "wifi_ssid_9", "wifi_ssid_9", ValueType::String},
    {"settings", "wifi_password_9", "wifi_pass_9", ValueType::String},
