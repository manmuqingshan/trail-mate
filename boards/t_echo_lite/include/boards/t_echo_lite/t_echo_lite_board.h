...
class TEchoLiteBoard final : public BoardBase
{
  public:
    class I2cGuard
    {
      public:
        explicit I2cGuard(TEchoLiteBoard& board, uint32_t timeout_ms = 100);
        ~I2cGuard();
      ...
      private:
        TEchoLiteBoard* board_ = nullptr;
        bool locked_ = false;
    };

    static TEchoLiteBoard& instance();
    ~TEchoLiteBoard() override;
    ...
    void setStatusLedColor(uint8_t color_index);
  ...
  private:
    ...
    bool audio_codec_ready_ = false;
    bool keyboard_backlight_ready_ = false;
