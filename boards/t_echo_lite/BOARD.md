# T-Echo Lite Board Facts

This board fact record is derived from:

- `docs/boards/T-Echo Lite.board.yaml`
...
- board package: `boards/t_echo_lite`
- board id used by existing board YAML: `T-Echo Lite`
- product identity strings in `kBoardProfile`: `T-Echo Lite`
