...
struct TEchoLiteBoardFacts
{
    const char* board_package = "boards/t_echo_lite";
    const char* board_id = "T-Echo Lite";
    const char* platform_family = "nrf52";
    const char* product_name = "T-Echo Lite";
...
inline constexpr TEchoLiteBoardFacts kBoardFacts{};
