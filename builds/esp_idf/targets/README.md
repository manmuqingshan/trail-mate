...
| `t_display_p4_tft` | `builds/esp_idf/targets/t_display_p4_tft/sdkconfig.defaults` | `removed root esp_idf/targets/t_display_p4_tft/sdkconfig.defaults` |
| `t_display_p4_amoled` | `builds/esp_idf/targets/t_display_p4_amoled/sdkconfig.defaults` | `removed root esp_idf/targets/t_display_p4_amoled/sdkconfig.defaults` |
